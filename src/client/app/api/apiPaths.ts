const apiPaths = {
	...
	avdelingslederEndreReservasjoner: '/api/k9-los-api/saksbehandler/oppgaver/reservasjon/endre',
	avdelingslederOpphevReservasjoner: '/api/k9-los-api/saksbehandler/oppgaver/opphev',
