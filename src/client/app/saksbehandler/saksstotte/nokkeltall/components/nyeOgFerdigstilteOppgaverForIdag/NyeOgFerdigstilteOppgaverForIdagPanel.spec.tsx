...
import {
	...
	getNyeOgFerdigstilteForIDag,
} from './NyeOgFerdigstilteOppgaverForIdagPanel';
...
describe('<NyeOgFerdigstilteOppgaverForIdagPanel>', () => {
	it('skal vise rendre komponent', () => {
		...
		const wrapper = shallow(
			<NyeOgFerdigstilteOppgaverForIdagPanel height={200} nyeOgFerdigstilteOppgaver={nyeOgFerdigstilteOppgaver} />,
		);
