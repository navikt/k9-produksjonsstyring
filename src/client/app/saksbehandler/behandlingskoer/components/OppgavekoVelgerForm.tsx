...
const getBehandlingstyper = (intl: IntlShape, alleKodeverk: AlleKodeverk, oppgaveko?: Oppgaveko) =>
    oppgaveko && oppgaveko.behandlingTyper.length > 0
        ? oppgaveko.behandlingTyper.map((type) =>
              getKodeverknavnFraKode(type, kodeverkTyper.BEHANDLING_TYPE, alleKodeverk),
          )
        : [intl.formatMessage({ id: 'OppgavekoVelgerForm.Alle' })];
                                    ...
                                    <>
                                        ...
                                        <FlexColumn className={styles.marginFilters}>
                                            <LabelWithHeader
                                                ...
                                                texts={getStonadstyper(
                                                    intl,
                                                    alleKodeverk,
                                                    getValgtOppgaveko(oppgavekoer, values.id),
                                                )}
                                            />
                                        </FlexColumn>
                                        <FlexColumn className={styles.marginFilters}>
                                        ...
                                        <FlexColumn className={styles.marginFilters}>
                                            <LabelWithHeader
                                                ...
                                                texts={[
                                                    getSorteringsnavn(intl, getValgtOppgaveko(oppgavekoer, values.id)),
                                                ]}
                                            />
                                        </FlexColumn>
                                    </>
