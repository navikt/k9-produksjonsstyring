 ...
 */
export const OpphevReservasjonModalV1: FunctionComponent<OwnProps> = ({ showModal, cancel, reservasjonsnøkkel }) => {
	...
	const opphevReservasjonFn = useCallback(
		(begrunnelse: string) =>
			opphevOppgavereservasjon({ reservasjonsnøkkel, begrunnelse }).then(() => {
...
export default OpphevReservasjonModalV1;
