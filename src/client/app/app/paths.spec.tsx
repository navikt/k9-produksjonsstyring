...
describe('paths', () => {
  test('får riktig url til k9', () => {
    ...
    expect(getK9sakHref(k9SakUrl, saksnummer, behandlingId, false)).not.toContain('harMerknad=true');
    expect(getK9sakHref(k9SakUrl, saksnummer, behandlingId, true)).toContain('harMerknad=true');
  });
});
