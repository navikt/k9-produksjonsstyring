...
if (process.argv.includes("--no-fix")) {
  ...
  config.module.rules.find(
    (rules) => rules.loader === "eslint-loader"
  ).options.fix = false;
}
    ...
    "/api/**": {
      ...
      onProxyRes: function onProxyRes(proxyRes, req, res) {
        ...
        if (
          ...
          proxyRes.headers.location.startsWith(process.env.AUTH_PROXY_URL)
        ) {
          proxyRes.headers.location = proxyRes.headers.location.split(
