...
const renderFjernSelectFeltKnapp = (felt, onFjern) => <Button icon={<Delete aria-hidden />} size="medium" variant="tertiary" onClick={() => onFjern(felt)} />;
...
const renderSelectFelt = (felter, felt, onOppdater, onFjern) => (
    <div className={styles.selectEnkelFelt} key={felt.id}>
      ...
      >
        ...
        {felter.map(feltdefinisjon => <option value={feltverdiKey(feltdefinisjon)}>{feltdefinisjon.visningsnavn}</option>)}
      </Select>
