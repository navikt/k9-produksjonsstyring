...
import { OppgaverPerForsteStonadsdagPanel } from 'avdelingsleder/nokkeltall/components/antallBehandlingerPerForsteStonadsdag/OppgaverPerForsteStonadsdagPanel';
