...
import { k9LosApi, RestApiGlobalStatePathsKeys } from 'api/k9LosApi';
...
const PROXY_REDIRECT_URL = isDev ? 'https://k9-los-oidc-auth-proxy.dev.intern.nav.no/login?redirect_uri=https://k9-los-web.dev.adeo.no/'
