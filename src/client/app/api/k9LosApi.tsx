import { createRequestApi } from 'api/rest-api';
import {
...
const endpoints = new RestApiConfigBuilder('/api')
  /* /api/fagsak */
  ...
  .withGet('konfig/k9tilbake-url', RestApiGlobalStatePathsKeys.K9TILBAKE_URL)

  /* /api/kodeverk */
  .withGet('kodeverk', RestApiGlobalStatePathsKeys.KODEVERK)

  .build();
const k9LosApi = createRequestApi(endpoints);
